...
function generarTablaMesas() {
    ...
    const tituloSeccionMesas = document.querySelector("#zona-mesas h2");
...
function actualizarTablaPedidos() {
    ...
    if (zonaPedidos && tabla) {
        ...
        // Usamos la .oculto en lugar de modificar el style.display
        if(hayPedidos)
...
function actualizarTextosFiltros() {
    ...
    const btnFin = document.querySelector("#btn-finalizar");
